insults = [
    ...
    "If I knew you were a cock I would have fed you corn.",
    "I shouldn't say anything to upset you, I know it's your time of the month.",
    "Has your existence been verified by science yet?",
    "I don't understand how they could cram so much ugly into one physical form.",
]
errormessage = "Dagnabbit! It looks like that failed."
max_nsfw_count = 5
command_prefixes = "t%"
owner_id = 466778567905116170
dev_ids = [606284419447128064, 466778567905116170]
Lock_Status = "no"
lock_status = Lock_Status
supporter_ids = [606284419447128064]
connection_url = "mongodb+srv://pinkalicious:panda500@cluster0.jbdrl.mongodb.net/test?authSource=admin&replicaSet=atlas-p914k5-shard-0&w=majority&readPreference=primary&appname=MongoDB%20Compass&retryWrites=true&ssl=true"
helpers = [503066505999679518]
github_bot_repo = "https://github.com/nosnowowie93347/Terrabot"
