...
class Google(commands.Cog):
	...
	async def translateto(self,ctx: commands.Context,language="",*query):
		if (len(language)==0 or language == 'help'):
			...
			em.add_field(name="Supported Languages", value="af: afrikaans, sq: albanian, am: amharic, ar: arabic, hy: armenian, az: azerbaijani, eu: basque, be: belarusian, bn: bengali, bs: bosnian, bg: bulgarian, ca: catalan, ceb: cebuano, ny: chichewa, zh-cn: chinese_simplified, zh-tw: chinese_traditional, co: corsican, hr: croatian, cs: czech, da: danish, nl: dutch, en: english, eo: esperanto, et: estonian, tl: filipino, fi: finnish, fr: french, fy: frisian, gl: galician, ka: georgian, de: german, el: greek, ht: haitian creole, ha: hausa, haw: hawaiian, iw: hebrew, he: hebrew, hi: hindi, hmn: hmong, hu: hungarian, is: icelandic, ig: igbo, id: indonesian, ga: irish, it: italian, ja: japanese, jw: javanese, kn: kannada, kk: kazakh, km: khmer, ko: korean, ku: kurdish (kurmanji)", inline=False)
